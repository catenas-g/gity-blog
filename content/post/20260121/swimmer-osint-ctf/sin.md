...
このひみつ結社の本格的な活動がDiver CTF参加から始まったことを考えると、初心者向けOSINT CTFの参加が自発的に生えてくるまでになったことに感慨深く思っています。

私は基本的にバックアップやしばらく動かない問題に参加するようにしたため（初回も初回で上の階でカレーを煮ていた気がします）解いた問題は多くありません。
...
この資料を確認すると、場所が大井町駅前店であることに矛盾はありませんでした。
...
この手の問題は大会後半になると正解となる投稿に参加者が多くアクセスするため、見つけやすくなる傾向があります。最後まで諦めずに挑戦しましょう。（もちろん現実でのOSINTでは関係ありません。）
...
画像内に病院の広告が2つ確認できたため、これらを検索すると実在する病院らしい。    
病院に近い駅のうち、奥に写っている高い建物との位置関係が良さそうなものを選定。
駅内の撮影場所を大まかに絞って提出。